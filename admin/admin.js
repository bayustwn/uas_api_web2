const API_BASE_URL = 'https://uasapibe-production.up.railway.app/api';
...
async function getMenus() {
    try {
        const response = await fetch('https://uasapibe-production.up.railway.app/api/menu',{
            headers: {
...
document.getElementById('addItemForm').addEventListener('submit', async function(e) {
    ...
    let url = 'https://uasapibe-production.up.railway.app/api/menu';
    let method = 'POST';
    if (id_menu) {
        url += `/${id_menu}`;
        method = 'PUT';
...
async function getOrders() {
    const response = await fetch('https://uasapibe-production.up.railway.app/api/orders');
...
async function getPayments() {
    try {
        const response = await fetch('https://uasapibe-production.up.railway.app/api/payment');
...
async function getUsers() {
    try {
        const response = await fetch('https://uasapibe-production.up.railway.app/api/users');
...
function attachPaymentEventListeners() {
    document.querySelectorAll('.payment-complete').forEach(btn => {
        btn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch(`https://uasapibe-production.up.railway.app/api/payments/${paymentId}/status`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    document.querySelectorAll('.user-delete').forEach(btn => {
        btn.addEventListener('click', async function() {
            ...
            if (confirm('Are you sure you want to delete this user?')) {
                try {
                    const response = await fetch(`https://uasapibe-production.up.railway.app/api/users/${userId}`, {
                        method: 'DELETE'
                    });
...
function attachOrderEventListeners() {
    document.querySelectorAll('.order-complete').forEach(btn => {
        btn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch(`https://uasapibe-production.up.railway.app/api/orders/${orderId}/status`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
...
async function deleteMenu(id_menu) {
    if (confirm('Are you sure you want to delete this menu item?')) {
        try {
            const response = await fetch(`https://uasapibe-production.up.railway.app/api/menu/${id_menu}`, {
                method: 'DELETE'
            });
            if (response.ok) {
...
function editMenu(id_menu) {
    ...
    fetch(`https://uasapibe-production.up.railway.app/api/menu/${id_menu}`)
        .then(res => res.json())
        .then(menu => {
